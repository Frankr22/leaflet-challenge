...
- CSS - the project includes a CSS file that styles the layout and design of the page.
- HTML - the project includes an HTML file that contains the structure and elements of the page, including the div for the map and the legend.
